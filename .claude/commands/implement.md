...
2. Execute it. For content: generate from the KB via the right skill/agent, every claim source-traced, into `workspaces/<project>/outputs/`. For 命理: calculators only (`.claude/calc/`), never hand-math.
